...
:::warning
Only whitelisted domains are allowed to embed. You can test things out on `localhost`, but if you want to actually deploy the iFrame on your site, contact us for domain whitelisting and further cooperation.
:::
