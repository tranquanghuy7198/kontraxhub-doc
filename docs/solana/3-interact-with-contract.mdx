...
To begin working with your Solana program in <ProductLabel />, choose one of the following methods:
...
Navigate to <PageLink id="contracts"/> to register your program.

## Interaction Modes

<ProductLabel /> provides two interaction modes to suit different use cases:
