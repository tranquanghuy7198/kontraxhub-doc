...
To begin working with your Solana program in <PageLink id="home" />, choose one of the following methods:
...
<PageLink id="home" /> provides two interaction modes to suit different use cases:
